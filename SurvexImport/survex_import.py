...
class SurvexImport:
    ...
    def run(self):
        ...
        if result:
            ...
            filename = self.dlg.selectedFile.text()
            QgsMessageLog.logMessage('Loading from %s' % filename, 'SurvexImport')
            if self.dlg.checkBoxLegs.isChecked():
                QgsMessageLog.logMessage('Import legs checked', 'SurvexImport')
            else:
                QgsMessageLog.logMessage('Import legs unchecked', 'SurvexImport')
            if self.dlg.checkBoxStations.isChecked():
                QgsMessageLog.logMessage('Import stations checked', 'SurvexImport')
            else:
                QgsMessageLog.logMessage('Import stations unchecked', 'SurvexImport')
