...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="color_dd_expression" v="ramp_color('Spectral',scale_linear(0.5*(z(start_point($geometry))+z(end_point($geometry))),@zmin,@zmax,1,0))"/>
  ...
  <aliases>
    ...
    <alias field="STYLE" index="1" name=""/>
    <alias field="DATE1" index="2" name=""/>
    <alias field="DATE2" index="3" name=""/>
    <alias field="NLEGS" index="4" name=""/>
    <alias field="LENGTH" index="5" name=""/>
    <alias field="ERROR" index="6" name=""/>
    <alias field="ERROR_HORIZ" index="7" name=""/>
    <alias field="ERROR_VERT" index="8" name=""/>
    <alias field="SURFACE" index="9" name=""/>
    <alias field="DUPLICATE" index="10" name=""/>
    <alias field="SPLAY" index="11" name=""/>
  </aliases>
